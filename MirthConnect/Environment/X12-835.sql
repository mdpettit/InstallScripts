...
(
	...
	[SourceMessageChecksum] varchar(255),
...
CREATE NONCLUSTERED INDEX [IX_X12Interchange_SourceMessageCheckSum]
 ON [X12].[InterchangeBASE] ([SourceMessageCheckSum] ASC)
GO
...
CREATE NONCLUSTERED INDEX IX_X12Interchange_LoadDTS ON X12.InterchangeBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12FunctionalGroup_LoadDTS ON X12.FunctionalGroupBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ClaimAdjustment_LoadDTS ON X12835.ClaimAdjustmentBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ClaimAmount_LoadDTS ON X12835.ClaimAmountBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835Claim_LoadDTS ON X12835.ClaimBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ClaimDate_LoadDTS ON X12835.ClaimDateBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ClaimPerson_LoadDTS ON X12835.ClaimPersonBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ClaimQuantity_LoadDTS ON X12835.ClaimQuantityBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ClaimReference_LoadDTS ON X12835.ClaimReferenceBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835Currency_LoadDTS ON X12835.CurrencyBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835Financial_LoadDTS ON X12835.FinancialBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835Header_LoadDTS ON X12835.HeaderBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835InpatientAdjudication_LoadDTS ON X12835.InpatientAdjudicationBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835OutpatientAdjudication_LoadDTS ON X12835.OutpatientAdjudicationBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835Payee_LoadDTS ON X12835.PayeeBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835PayeeReference_LoadDTS ON X12835.PayeeReferenceBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835Payer_LoadDTS ON X12835.PayerBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835PayerContact_LoadDTS ON X12835.PayerContactBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835PayerReference_LoadDTS ON X12835.PayerReferenceBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ProviderAdjustment_LoadDTS ON X12835.ProviderAdjustmentBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ProviderSummaryInformation_LoadDTS ON X12835.ProviderSummaryInformationBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ProviderSupplementalInformation_LoadDTS ON X12835.ProviderSupplementalInformationBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ServiceAdjustment_LoadDTS ON X12835.ServiceAdjustmentBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ServiceAmount_LoadDTS ON X12835.ServiceAmountBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835Service_LoadDTS ON X12835.ServiceBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ServiceDate_LoadDTS ON X12835.ServiceDateBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ServiceQuantity_LoadDTS ON X12835.ServiceQuantityBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ServiceReference_LoadDTS ON X12835.ServiceReferenceBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835ServiceRemark_LoadDTS ON X12835.ServiceRemarkBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835TraceNumber_LoadDTS ON X12835.TraceNumberBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835Transaction_LoadDTS ON X12835.TransactionBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835TransactionDate_LoadDTS ON X12835.TransactionDateBASE (LoadDTS)

CREATE NONCLUSTERED INDEX IX_X12835TransactionReference_LoadDTS ON X12835.TransactionReferenceBASE (LoadDTS)
